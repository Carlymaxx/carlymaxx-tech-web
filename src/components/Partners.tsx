  ...
  <section className="py-16 bg-gradient-to-br from-gray-50 to-white">
    <div className="container mx-auto px-6">
      ...
      <div className="flex flex-wrap justify-center gap-6 max-w-4xl mx-auto">
        ...
        <a href="mailto:cybernexust3ch@gmail.com" className="group flex items-center gap-4 bg-white rounded-2xl border border-gray-100 px-8 py-5 shadow-sm hover:shadow-xl hover:border-cyan-200 transition-all hover:-translate-y-1">
