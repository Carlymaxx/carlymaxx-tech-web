...
const ProcessTimeline = () => (
  <section className="py-20 bg-gradient-to-br from-gray-50 to-white"><div className="container mx-auto px-6">
    ...
    <div className="max-w-5xl mx-auto">
      <div className="flex flex-nowrap justify-center gap-8 relative overflow-x-auto pb-4">
        <div className="hidden md:block absolute top-10 left-[10%] right-[10%] h-0.5 bg-gray-200"></div>
        {steps.map((s, i) => (
          <div key={i} className="flex-shrink-0 w-40 relative text-center">
            <div className={`${s.color} h-20 w-20 rounded-2xl mx-auto mb-4 flex items-center justify-center text-white shadow-lg relative z-10 hover:scale-110 transition-transform`}>
